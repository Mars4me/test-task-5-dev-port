    ...
    <div class="container">
      ...
      <form @submit.prevent="login">
        ...
        <div class="form-group">
          <input type="text" id="username" required placeholder="Username" v-model="username" @keypress="handleInput">
          <p v-if="usernameError" class="error-message">Username should only contain letters.</p>
        </div>
        <div class="form-group last-form-item">
          <input type="text" id="phoneNumber" @keypress="handleInput" required v-model="phoneNumber"
            placeholder="Phone Number">
          <p v-if="phoneNumberError" class="error-message">Phone number should only contain digits and (+-.,:;).</p>
        </div>
...
export default {
  ...
  methods: {
    ...
    login() {
        ...
        console.log(this.username, this.phoneNumber, user, 'userdddd')
